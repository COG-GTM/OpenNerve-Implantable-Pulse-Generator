...
#define	SPID_BIPHASIC_PULSE_FREQUENCY		"SP23"		/*!< Parameter ID of "BIPHASIC_PULSE_FREQUENCY" */
#define	SPID_BIPHASIC_TRAIN_ON_DURATION		"SP24"		/*!< Parameter ID of "BIPHASIC_TRAIN_ON_DURATION" */
#define	SPID_BIPHASIC_TRAIN_OFF_DURATION	"SP25"		/*!< Parameter ID of "BIPHASIC_TRAIN_OFF_DURATION" */
