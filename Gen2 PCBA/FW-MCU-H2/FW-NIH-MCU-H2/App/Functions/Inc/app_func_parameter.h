...
#define	SPID_BIPHASIC_CATHODIC_WIDTH	"SP20"		/*!< Parameter ID of "BIPHASIC_CATHODIC_WIDTH" */
#define	SPID_BIPHASIC_ANODIC_WIDTH		"SP21"		/*!< Parameter ID of "BIPHASIC_ANODIC_WIDTH" */
#define	SPID_BIPHASIC_INTERPHASE_GAP	"SP22"		/*!< Parameter ID of "BIPHASIC_INTERPHASE_GAP" */
#define	SPID_BIPHASIC_FREQUENCY			"SP23"		/*!< Parameter ID of "BIPHASIC_FREQUENCY" */
#define	SPID_BIPHASIC_AMPLITUDE			"SP24"		/*!< Parameter ID of "BIPHASIC_AMPLITUDE" */
#define	SPID_BIPHASIC_TRAIN_ON			"SP25"		/*!< Parameter ID of "BIPHASIC_TRAIN_ON" */
#define	SPID_BIPHASIC_TRAIN_OFF			"SP26"		/*!< Parameter ID of "BIPHASIC_TRAIN_OFF" */
